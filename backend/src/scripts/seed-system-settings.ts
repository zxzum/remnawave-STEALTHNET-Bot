...
const DEFAULTS: Array<[string, string]> = [
  ...
  ["lazeika_only_notification_message_1", "🇪🇺 Telegram + lazeika.xyz"],
  ["lazeika_only_notification_message_2", "🇪🇺 Telegram + lazeika.xyz"],
  ["lazeika_only_notification_message_3", "🇪🇺 Telegram + lazeika.xyz"],
  [
