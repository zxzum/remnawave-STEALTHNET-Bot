...
import { subscriptionConversionRouter } from "./modules/client/subscription-conversion.routes.js";
...
import { lazeikaOnlyRouter } from "./modules/lazeika-only/lazeika-only.routes.js";
...
app.use("/api/admin/lazeika-only", lazeikaOnlyRouter);
...
app.use("/api/client/subscription-conversion", subscriptionConversionRouter);
